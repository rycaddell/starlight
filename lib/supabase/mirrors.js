...

{
  "biblical_profile": {
    ...
    "connection": "2 sentences connecting their spiritual journey to this biblical figure"
  },
  "encouraging_verse": {
    "reference": "Bible verse reference",
    "text": "Full verse text",
    "application": "2 sentences about how this verse speaks to their current situation"
  }
}
...
export const generateOnboardingPreview = async (journalContent) => {
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [{ role: "user", content: prompt }],
      max_completion_tokens: 800, // Much smaller than full Mirror
      temperature: 0.7,
    });
