...
export const generateOnboardingPreview = async (journalContent) => {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      // Even on error, the Edge Function returns fallback content
      return { 
        success: true, 
...
// ============================================================================
// DEPRECATED - OLD CLIENT-SIDE GENERATION (Remove after Phase 3 complete)
// ============================================================================

// These functions are no longer used but kept temporarily for reference
// TODO: Remove after confirming new flow works in production
